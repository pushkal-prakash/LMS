...
import java.sql.*;
import java.io.*;
public class  GetStudentTestSubjects extends HttpServlet
{
	public  void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException
	{
		...
		String departmentid="";
		System.out.println("in test subject ***"+userid);
		...
		Class.forName("oracle.jdbc.driver.OracleDriver");
			...
			session.setAttribute("testsubjectlist",vector);
			session.setAttribute("subjectid",subjectid);
			
			
			dispatcher=request.getRequestDispatcher("StudentTest.jsp");
