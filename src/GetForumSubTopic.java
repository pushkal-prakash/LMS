...
import java.sql.*;
import java.io.*;
public class  GetForumSubTopic extends HttpServlet
{
	public  void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException
	{
		...
		System.out.println("in student query -------"+subjectid);
		...
		try
		{
			...
			dispatcher=request.getRequestDispatcher("StudentPostQuery.jsp");
