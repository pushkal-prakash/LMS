...
<table width="770" border="0" cellpadding="0" cellspacing="0" align="center">
  <tr> 
    <td style="padding-left:25px" bgcolor="#009999" height="100" class="logo"><img src="images/evms_learning_management.jpg" width="100" height="100"><span class="style17">COLLEGE INTERACTO</span> </td>
  </tr>
  <tr> 
...
<table width="770" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr> 
    <td valign="top" bgcolor="#FFFFFF">
      <table width="100%" border="0" cellspacing="0" cellpadding="15">
        <tr> 
          <td class="title" height="60" background="images/title_bg.gif" align="right"><div align="center" class="style5"> Select Subject</div></td>
        </tr>
        <tr> 
          <td valign="top" class="text"> 
            <p><form name="form1" method="post" action="getcontentsubtopic" onsubmit="return Validate()">
  <p>&nbsp;</p>
  <table width="396" border="0" align="center">
    ...
    <tr>
      <td><span class="style16">Subject Name </span></td>
      <td><select name="subjectid" id="subjectid">
        <option value="0" selected="selected">--Select--</option>
        <%
			Vector subjlist = (Vector)session.getAttribute("contentsubjectlist");
			System.out.println("sublist----"+subjlist);
			if(subjlist!=null)
			{
  ...
  <p>&nbsp;</p>
    ...
    <td width="191" bgcolor="#E5E5E5" valign="top"><img src="images/top02.gif" width="191" height="87"><br>
      <img src="images/admin2.jpg" width="200" height="222"></td>
  </tr>
</table>
<table width="770" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr> 
