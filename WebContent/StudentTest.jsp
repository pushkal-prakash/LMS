    ...
    <td valign="top" bgcolor="#FFFFFF">
      <table width="100%" border="0" cellspacing="0" cellpadding="15">
        ...
        <tr> 
		  ...
		  <form name="form1" id="form1" method="post" action="getstudenttestsubtopic" onsubmit="return Validate()">
              ...
              <tr>
                ...
                <td><select name="subjectid" id="subjectid">
				  ...
				  <%
			Vector subjlist = (Vector)session.getAttribute("testsubjectlist");
			if(subjlist!=null)
			{
