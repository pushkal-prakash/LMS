...
{
window.alert("enter subject name");
doc.subject.focus();
return false;
}

if(doc.departmentid.value=="--select--")
{
window.alert("select department name");
doc.departmentid.focus();
return false;
}
}
...
<table width="770" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr> 
    <td valign="top" bgcolor="#FFFFFF">
      <table width="100%" border="0" cellspacing="0" cellpadding="15">
        <tr> 
          <td class="title" height="60" background="images/title_bg.gif" align="right"><div align="center" class="style5">Subject Registration</div></td>
        </tr>
        <tr> 
          <td valign="top" class="text"> 
            <p><form name="form1" method="post" action="subjectregistration">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <table width="372" height="143" border="0" align="center">
  <tr>
  <td height="34"><span class="style4">Department Name </span></td>
  ...
  %>
    ...
    <tr>
      <td width="180"><span class="style4">Subject Name</span></td>
      <td width="182"><input name="subject" type="text" id="subject"></td>
    </tr>
    <tr>
